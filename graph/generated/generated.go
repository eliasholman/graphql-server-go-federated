...
func (ec *executionContext) _Entity_findCustomerByID(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNCustomer2ᚖmyᚋgraphqlᚋdemoᚋgraphᚋmodelᚐCustomer(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Order_buyer(ctx context.Context, field graphql.CollectedField, obj *model.Order) (ret graphql.Marshaler) {
	...
	res := resTmp.(*model.Customer)
	fc.Result = res
	return ec.marshalOCustomer2ᚖmyᚋgraphqlᚋdemoᚋgraphᚋmodelᚐCustomer(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Order(ctx context.Context, sel ast.SelectionSet, obj *model.Order) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "buyer":
			innerFunc := func(ctx context.Context) (res graphql.Marshaler) {
				return ec._Order_buyer(ctx, field, obj)
			}
...
func (ec *executionContext) marshalNCustomer2myᚋgraphqlᚋdemoᚋgraphᚋmodelᚐCustomer(ctx context.Context, sel ast.SelectionSet, v model.Customer) graphql.Marshaler {
	return ec._Customer(ctx, sel, &v)
}

func (ec *executionContext) marshalNCustomer2ᚖmyᚋgraphqlᚋdemoᚋgraphᚋmodelᚐCustomer(ctx context.Context, sel ast.SelectionSet, v *model.Customer) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
...
func (ec *executionContext) marshalOCustomer2ᚖmyᚋgraphqlᚋdemoᚋgraphᚋmodelᚐCustomer(ctx context.Context, sel ast.SelectionSet, v *model.Customer) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._Customer(ctx, sel, v)
